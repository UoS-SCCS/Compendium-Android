 ...
 * </intent-filter>
 */
public class CompendiumFirebaseNotificationService extends FirebaseMessagingService {
    public CompendiumFirebaseNotificationService() {

        Log.i(TAG, "NotificationServiceStarted");


    }

    private static final String TAG = "CompendiumFirebaseNotificationService";
    ...
    {
        sendNotification("Companion Device Request",data);
     ...
     *
     * @param messageString FCM message body received.
     */
    private void sendNotification(String messageString, Map<String, String> data) {
        Intent intent = new Intent(this, CompendiumRequestActivity.class);
